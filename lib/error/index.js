...
/**
 * MysqlseError constructor. MysqlseError is the base class for all
 ...
 * possible values are:
 *
 * - `MysqlseError`: general Mongoose error
...
module.exports = exports = MysqlseError;

/**
 * The default built-in validator error messages.
 *
 * @see Error.messages #error_messages_MysqlseError-messages
 * @api public
 * @memberOf Error
 * @static messages
 */

MysqlseError.messages = require('./messages');

// backward compat
MysqlseError.Messages = MysqlseError.messages;
...
MysqlseError.DocumentNotFoundError = require('./notFound');
...
MysqlseError.CastError = require('./cast');
...
MysqlseError.ValidationError = require('./validation');
...
MysqlseError.ValidatorError = require('./validator');
...
MysqlseError.VersionError = require('./version');
...
MysqlseError.ParallelSaveError = require('./parallelSave');
...
MysqlseError.OverwriteModelError = require('./overwriteModel');
...
MysqlseError.MissingSchemaError = require('./missingSchema');
...
MysqlseError.DivergentArrayError = require('./divergentArray');
...
MysqlseError.StrictModeError = require('./strict');
